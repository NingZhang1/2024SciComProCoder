!subroutine BASIS_INT(kbasst,kbased,kcenter,ncenters,nconts,coord,atomchg,S,Hcore,TWOEIout,baselable)
subroutine BASIS_INT(kbasst,kbased,kcenter,ncenters,nconts,coord,atomchg,S,Hcore,baselable)
implicit none
! input data zone
...
!print*,nconts,nRec
allocate(TWOEI(nRec))
call basisint(kbasst,kbased,kcenter,ncenters,coord,atomchg,baselable,nconts,S,Hcore,nRec,TWOEI)
!write(*,*)nconts
do i = 1,nconts
   do j=1,nconts
      do k=1,nconts
...
!===============================
subroutine basisint(kbasst,kbased,kcenter,ncenters,coord,atomchg,baselable,n1,Sout,Hcoreout,n2,TWOEIout)
